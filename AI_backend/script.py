...
def generate_summary(file_name, top_n=5):
    ...
    # print(" ".join(ranked_sentence[3][1]))
    # print(top_n)
    if int(top_n) > len(ranked_sentence):
        someValue = len(ranked_sentence)
    else:
        someValue = top_n
    for i in range(int(someValue)):
        # print(ranked_sentence[i][1])
        summarize_text.append(" ".join(ranked_sentence[i][1]))
    # print("Entered the generate summary")
